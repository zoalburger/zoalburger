odoo.define('pos_retail.ButtonCreateInternalTransfer', function (require) {
    ...
    class ButtonCreateInternalTransfer extends PosComponent {
        ...
        async onClick() {
            if (!this.env.pos.config.internal_transfer_picking_type_id) {
                return this.showPopup('ErrorPopup', {
                    title: this.env._t('Warning, Missed Setting'),
                    body: this.env._t('Please assign your admin go to Warehouse Tab of POS Config, assign Internal Transfer Picking Type')
                })
            }
            const self = this;
            ...
            //     })
            // }
            let allLocations = this.env.pos.stock_locations
